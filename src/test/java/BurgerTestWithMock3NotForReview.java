...
public class BurgerTestWithMock3NotForReview {
	...
	public void moveIngredientBurger() {
		...
		burger3.moveIngredient(0, 0);

		String expectedMovedIngredient = "sausage";
		String actualMovedIngredient = ingredient.getName();
	...
	public void removeIngredientFromBurger() {
		...
		String expectedRemovedIngredient = null;
